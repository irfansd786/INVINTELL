  ...
  return (
    <AnimatePresence>
      <div className="modal-backdrop" onClick={onClose}>
        <motion.div 
          key={inventoryItem.id || inventoryItem.productId || 'reconcile-modal'}
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="modal-body">
            ...
            <div className="field-group" style={{ marginTop: '16px' }}>
              <label className="field-lbl">RECONCILIATION AUDIT REASON</label>
              <select 
                value={reason} 
            ...
            {/* Result Notification */}
            {resultMsg && (
              <div className={`result-alert ${resultMsg.type === 'success' ? 'alert-success' : 'alert-error'}`}>
