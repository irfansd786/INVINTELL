    ...
    >
      ...
      <div className="inventory-toolbar">
        ...
        <div className="filter-controls-row">
          <select value={whFilter} onChange={(e) => setWhFilter(e.target.value)} className="top-wh-select">
              ...
              {filteredInventory.map((inv, idx) => {
                ...
                return (
                  <tr key={inv.id || `inv-${idx}`}>
                    <td><strong>{inv.productName || inv.name}</strong></td>
                    ...
                    <td>
                      <div className="flex-align-gap-2">
                        <button className="btn-secondary btn-sm" onClick={() => setSelectedProduct(inv)}>
                          <Eye size={12} /> DETAILS
                        </button>

                        <button className="btn-primary btn-sm" onClick={() => setReconcileTarget(inv)}>
