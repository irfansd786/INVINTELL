  ...
  return (
    ...
    >
      ...
      <section className="kpi-strip-v2 kpi-strip-overview" aria-label="Key Operational Indicators">
        ...
        <div className="kpi-card-v2" onClick={() => navigate('/inventory')} style={{ cursor: 'pointer' }}>
        ...
        <div className="kpi-card-v2" onClick={() => navigate('/orders')} style={{ cursor: 'pointer' }}>
        ...
        <div className="kpi-card-v2" onClick={() => navigate('/allocation')} style={{ cursor: 'pointer' }}>
        ...
        <div className="kpi-card-v2" onClick={() => navigate('/picking')} style={{ cursor: 'pointer' }}>
        ...
        <div className="kpi-card-v2" onClick={() => navigate('/packing')} style={{ cursor: 'pointer' }}>
        ...
        <div className="kpi-card-v2" onClick={() => navigate('/dispatch')} style={{ cursor: 'pointer' }}>
      ...
      <div className="overview-three-col">
        ...
        <section className="v2-block">
          <div className="block-header">
            <div>
              <h2 className="v2-section-title">TODAY'S REVENUE TRAJECTORY</h2>
        ...
        <section className="v2-block">
          <div className="block-header">
            <h2 className="v2-section-title">INVENTORY BY STATUS</h2>
        ...
        <section className="v2-block">
          ...
          <button className="v2-inline-link link-mt" onClick={() => navigate('/risks')}>
            View all risks →
          </button>
        </section>
      </div>
      ...
      <section className="v2-block">
        <div className="block-header">
          <div>
            <h2 className="v2-section-title">WAREHOUSE PERFORMANCE & REVENUE ATTRIBUTION</h2>
